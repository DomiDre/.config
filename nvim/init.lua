  ...
  },
  {
    ...
    opts = {
      projects = { -- define project roots
        "/run/media/domidre/DresenArbeitsSSD/apps/*",
        "/run/media/domidre/DresenArbeitsSSD/apps/df_detectors/*",
        "/run/media/domidre/DresenArbeitsSSD/projekte/secmedid/*",
      },
      picker = {
    ...
    priority = 100,
    keys = {
      { mode = "n", "<Leader>p", ":NeovimProjectDiscover<CR>", desc = "Discover project" },
    },
  },
  {
